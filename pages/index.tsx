  ...
  return (
    <Card>
      ...
      <div style={{ padding: "0 16px 16px 16px" }}>
        <MenuItem to="/signature-item">{t("common:menu.signature-item")}</MenuItem>
        <MenuItem to="/elite-summon">{t("common:menu.elite-summon")}</MenuItem>
        <MenuItem to="/loot">{t("common:menu.loot")}</MenuItem>
        <MenuItem to="/fast-reward">{t("common:menu.fast-reward")}</MenuItem>
        <MenuItem to="/hero-list">{t("common:menu.hero-list")}</MenuItem>
        <MenuItem to="/top-team">{t("common:menu.top-team")}</MenuItem>
        <MenuItem to="/item-cost">{t("common:menu.item-cost")}</MenuItem>
        <MenuItemExternal
