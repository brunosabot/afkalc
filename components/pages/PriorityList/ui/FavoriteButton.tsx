...
const FavoriteButton: React.FC<IProps> = ({ title, listId, userId }) => {
  ...
  const favoriteList = favoriteResult.data ?? {};
  const isFavorite = favoriteList[key] !== undefined;
