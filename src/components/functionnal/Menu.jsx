  ...
  return (
    <>
      ...
      <MenuContent isActive={isActive} setIsActive={setIsActive}>
        ...
        <MenuItem to="/signature-item">SI Emblem</MenuItem>
        <MenuItem to="/elite-summon">Elite summon</MenuItem>
        <MenuItem to="/loot">Loot</MenuItem>
        <MenuItem to="/hero-list">Hero List (Beta)</MenuItem>
        <MenuItem to="/fast-reward">Fast Reward</MenuItem>
        <MenuItemExternal
