  ...
  return (
    <Card>
      <div className="emblem-count__block">
        ...
        <EmblemChip count={primordial} image="/emblem/PrimEmb.jpg" name={t("item-primordial-emblem")} />
        <EmblemChip count={amplifying} image="/emblem/ApmEmblem.jpg" name={t("item-amplifying-emblem")} />
        <EmblemChip count={faction} image="/emblem/GbEmblem.jpg" name={t("item-faction-emblem")} />
        <EmblemChip count={celest} image="/emblem/CeleEmb.jpg" name={t("item-celest-Hypogean-emblem")} />
      </div>
    </Card>
  );
};
