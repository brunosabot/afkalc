...
const FastReward = () => {
  ...
  const [campaignLevel, setCampaignLevel] = useFirestoreWithBackup(
    "%ID%",
    "fast-reward",
    "campaign",
    "12-40"
  ...
  return (
    <div>
      ...
      <Card>
        ...
        <DiamondLine campaignLevel={campaignLevel} diams={diams50} count={50} />
        <DiamondLine campaignLevel={campaignLevel} diams={diams80} count={80} />
        <DiamondLine campaignLevel={campaignLevel} diams={diams100} count={100} />
      </Card>
    </div>
  );
};
